#!/usr/bin/env node
/**
 * `release:check-versions` — DECLARED, NOT IMPLEMENTED. Scenario 14 owns this.
 *
 ...
 * `pnpm release:check-versions && ship` would ship an unnotarised, unsigned,
 * unsmoked artefact and report success. Refusing loudly means the pipeline
 * stops at the step that has not been built yet.
 *
 * When implemented, this will: fail on any drift between the version fields of every workspace package.json.
 */
process.stderr.write(
  'release:check-versions: not implemented yet (Scenario 14 of s9-execution owns it).\n' +
